...
const getQuery2 = "SELECT DISTINCT d.doctor_name AS Doctor, d.specialisation AS Specialisation FROM Doctor AS d INNER JOIN Record AS r ON d.doctor_id = r.doctor_id WHERE consultation_date = '2021-06-30'";
...
const getQuery5 = "SELECT COUNT(DISTINCT p_id ) AS 'No.of people' FROM Record AS r INNER JOIN Service AS s ON r.service_id = s.service_id WHERE s.service_name = 'Vaccination'";
